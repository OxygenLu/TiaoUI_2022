...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_pause.setStyleSheet("border:0px;\n"
                                     "\n"
        ...
        self.gridLayout.addWidget(self.btn_pause, 7, 2, 1, 1)
        self.btn_join = QtWidgets.QPushButton(self.window)
        self.btn_join.setStyleSheet("border:0px;\n"
                                    "\n"
                                    "/*background-image:url(:/images/btn-menu-02.png);*/\n"
                                    "\n"
                                    "/*font:16px \"微软雅黑\";*/\n"
        ...
        self.gridLayout.addWidget(self.btn_join, 1, 1, 1, 2)
        self.checkBox = QtWidgets.QCheckBox(self.window)
        self.checkBox.setObjectName("checkBox")
        self.gridLayout.addWidget(self.checkBox, 11, 1, 1, 2)
        self.btn_start = QtWidgets.QPushButton(self.window)
        self.btn_start.setStyleSheet("border:0px;\n"
                                     "\n"
                                     "/*background-image:url(:/images/btn-menu-02.png);*/\n"
                                     "\n"
                                     "/*font:16px \"微软雅黑\";*/\n"
        ...
        self.gridLayout.addWidget(self.btn_start, 6, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.label_res, 10, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.textBrowser, 12, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.frame, 0, 0, 14, 1)
        self.btn_get_ctrl = QtWidgets.QPushButton(self.window)
        self.btn_get_ctrl.setStyleSheet("border:0px;\n"
                                        "\n"
                                        "/*background-image:url(:/images/btn-menu-02.png);*/\n"
                                        "\n"
                                        "/*font:16px \"微软雅黑\";*/\n"
        ...
        self.gridLayout.addWidget(self.btn_get_ctrl, 7, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.listView, 5, 1, 1, 2)
        ...
        self.gridLayout.setRowStretch(12, 2)
